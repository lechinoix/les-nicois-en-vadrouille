...
!(function (t, n) {
		...
		return s
			? (function (t, n, r) {
					...
					if (Array.isArray(n)) {
						...
						return function (i) {
							var o = r(i);
							if (null == o) for (var u = 0; u < e; u++) t[u].removeAttribute(n);
				...
				[
					{
						...
						value: function () {
							...
							(this.rollbackStartOffset = this.offset),
								this._rollingBack || ((this._rollingBack = !0), (this._running = !0));
	...
	var ht = {
			f: null,
			i: function (t, n, r) {
				return 0 === t ? n : 1 === t ? r : { x: q(t, n.x, r.x), y: q(t, n.y, r.y) };
			},
			u: function (t, n) {
				return function (r) {
					var e = n(r);
		...
		vt = {
			...
			i: function (t, n, r) {
				return 0 === t
					...
					: 1 === t
					? r
					: { width: q(t, n.width, r.width), height: q(t, n.height, r.height) };
			},
			u: function (t, n) {
				return function (r) {
					var e = n(r);
	...
	function At(t, n, r, e) {
		var i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
			o = bt(t, n, null, r, e);
		return (
			o || (o = { x: wt(t.x, n.x, r.x, e), y: wt(t.y, n.y, r.y, e) }),
			i && (o.a = kt(t, n, r, e)),
			o
		);
	}
	...
	function Ot(t, n, r, e, i) {
		var o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5],
			u = bt(t, n, r, e, i);
		return (
			u || (u = { x: St(t.x, n.x, r.x, e.x, i), y: St(t.y, n.y, r.y, e.y, i) }),
			o && (u.a = jt(t, n, r, e, i)),
			u
		);
	}
	...
	function Pt(t, n, r) {
		var e = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
			i = { x: Mt(t.x, n.x, r), y: Mt(t.y, n.y, r) };
						...
						if (r.r === e.r) {
							...
							return (
								...
								r.c
									...
									: r.f && ((o.f = C(t, r.f, e.f)), (o.to = C(t, r.to, e.to))),
								o
							);
						}
				}
		...
		animations: [
			{
				elements: {
					e81cHe9uma06: {
						transform: {
							data: { t: { x: -48.0895, y: -48.026501 } },
							keys: {
								o: [
									{ t: 0, v: { x: 125, y: 48.026501, type: 'corner' } },
									{ t: 1500, v: { x: 48, y: 48.026501, type: 'corner' } },
									{ t: 2990, v: { x: -25, y: 48.026501, type: 'corner' } },
									{ t: 3000, v: { x: 125, y: 48.026501, type: 'corner' } }
								]
							}
						},
						opacity: [
					...
					e81cHe9uma09: {
						transform: {
							data: { t: { x: -56.610933, y: -27.029001 } },
							keys: {
								o: [
									{ t: 0, v: { x: 56.610933, y: 27.029001, type: 'corner' } },
									{
										t: 1500,
										v: {
											x: -30,
											y: 27.029001,
											type: 'cusp',
											start: { x: -30, y: 27.029001 },
											end: { x: -30, y: 27.029001 }
										}
									},
									{
										t: 1510,
										v: {
											...
											y: 27.029001,
											type: 'cusp',
											start: { x: 130, y: 27.029001 },
											end: { x: 130, y: 27.029001 }
										}
									},
									{
										t: 3000,
										v: { x: 56.1, y: 27.029001, type: 'corner', start: { x: 56.1, y: 27.029001 } }
									}
								]
							}
						},
				...
				s: '|'
			}
		],
		options: 'MRDAxMDg4MmY4MDgxVjGZlWDdmODEyZjQ3UzJImNzk3YzZlNzEyZjhhX'
	},
	'__SVGATOR_PLAYER__',
	window
);
